...
//		int balance=10_000;
	...
	private static int newBalance(int firstBalance, int transAction) {
		int count = 0;
		int newBalance = 0;
		if (count == 0)
			newBalance = firstBalance - transAction;
		if (count > 0)
			newBalance = newBalance - transAction;
